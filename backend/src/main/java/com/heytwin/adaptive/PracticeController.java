...
public class PracticeController {
    ...
    public ResponseEntity<ApiResponse<PracticeSessionStartResponse>> startSession(
        ...
        return ResponseEntity.ok(ApiResponse.<PracticeSessionStartResponse>builder()
    ...
    public ResponseEntity<Void> submitResponse(Principal principal,
                                               @PathVariable UUID sessionId,
                                               @Valid @RequestBody PracticeResponseRequest request) {
