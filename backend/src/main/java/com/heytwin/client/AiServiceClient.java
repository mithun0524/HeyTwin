...
public class AiServiceClient {
    ...
    public AiPredictionResponse predict(AiPredictionRequest request) {
        try {
            ResponseEntity<AiPredictionResponse> response = aiRestTemplate.exchange(
                    "/predict",
                    HttpMethod.POST,
        ...
        return AiPredictionResponse.builder()
                ...
                .predictions(request.getInstances().stream()
                        .map(instance -> AiPredictionResponse.Item.builder()
